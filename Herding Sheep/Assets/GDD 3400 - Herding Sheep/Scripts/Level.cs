...
namespace GDD3400.Project01
{
    public class Level : MonoBehaviour
    {
        ...
        public void GenerateLevel()
        {
            ...
            // Spawn Dog (I am sorry for touching this code but I can still make it beilivable if I have the dog start at the middle and then procede to follow a trained path)
